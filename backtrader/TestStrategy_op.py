...
if __name__ == '__main__':
    ...
    datapath = os.path.join(homepath, 'auto_trade/local/backtrader/datas/2019-day-nifty.csv')
    ...
    datapath = os.path.join(homepath,'Desktop/History_Data/ES/2020/04_ESU2020_FUT.csv')
